...
preview обычных файлов в браузере

открытия doc/docx/xls/xlsx/ppt/pptx через BX.Disk.Viewer

отдельной кнопки Скачать

укороченных breadcrumbs
