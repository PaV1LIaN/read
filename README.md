Вот полный актуальный script.js с учетом:

bootstrap

корректного sessid

открытия папок по клику

preview файлов в браузере через previewUrl

скачивания через downloadUrl

нормальных breadcrumbs без “Общий диск / SiteBuilder”

table/grid

upload/createFolder/rename/delete/search/settings
...
После замены обязательно сделай Ctrl + F5, чтобы браузер не оставил старый JS в кэше.